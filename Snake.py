...
class Snake(Canvas):
    ...
    def load_img(self):
        try:
            self.snake_body = ImageTk.PhotoImage(Image.open('baghdad_history.png'))
            self.food = ImageTk.PhotoImage(Image.open('baghdad_history.png'))
